namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string PhotonAppID = "e4cb24c9-fe13-4372-ada8-827e16d5f9f2";
        ...
        public static float photonDisconnectTimeout = 17.0f; // In game scene - its better to don't change it. Player that loose focus on app will be immediately disconnected
